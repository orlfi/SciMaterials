namespace SciMaterials.DAL.Contracts.Initialization;
...
public interface IDatabaseInitializer
{
    ...
    Task<bool> DeleteDatabaseAsync(CancellationToken Cancel = default);
    ...
    /// <exception cref="OperationCanceledException"></exception>
    Task InitializeDatabaseAsync(bool RemoveAtStart = false, bool UseDataSeeder = false, CancellationToken Cancel = default);
}